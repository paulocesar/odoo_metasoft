...
(function() {
  var Metasoft, buildValidatorFunc, devaultMaskMoneyVal, errorLabel, fieldValidator, inputBackgroundColor, jsRoot, masks, validators, _;
  ...
  masks = {
    'mask-money': function($el) {
      ...
      return $el.val(devaultMaskMoneyVal);
    }
  };
