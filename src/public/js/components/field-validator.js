...
(function() {
  var Metasoft, buildValidatorFunc, errorLabel, fieldValidator, hasClasses, hasMoneyClass, inputBackgroundColor, jsRoot, masks, money, rgxNotBankDigit, rgxNotDigit, setDataInterval, validators, _;
  ...
  setDataInterval = function($el) {
    return $el.each(function() {
      ...
      if (f.hasClass('only-date-past')) {
        return f.data("DateTimePicker").maxDate(moment());
      }
    });
  };
