...
(function() {
  var Contas, F, Metasoft, fieldSearch, jsRoot, loadMoreHtml, modals, moment, todayDate, todayMonth, _,
  ...
  Contas = (function(_super) {
    ...
    function Contas(opts) {
      ...
      this.$('#contasSearchForm .data').on('dp.change', this.doSearch);
      this.$('#contasSearchForm .data').data("DateTimePicker").disable();
    ...
    Contas.prototype.onChangePeriodo = function() {
      var $dateField, $periodField, d;
      $periodField = this.$('#contasSearchForm .periodo');
      this.period = $periodField.val();
      $dateField = this.$('#contasSearchForm .data');
    ...
    Contas.prototype.onClickMoveDate = function(ev) {
      var $date, $el, date, format, increment, mustDecrement, type;
      if (this.period === 'qualquer') {
        return;
      }
      $el = $(ev.currentTarget);
      mustDecrement = $el.hasClass('decrement');
      $date = this.$('#contasSearchForm .data');
      date = $date.val();
      type = 'days';
      format = 'DD/MM/YYYY';
      if (this.period === 'mes') {
